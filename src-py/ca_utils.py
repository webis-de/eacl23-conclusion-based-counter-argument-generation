...
gretz_model = BertForSequenceClassification.from_pretrained('../sample-data/argument-quality-model', local_files_only=True, cache_dir='cache')
...
target_identifier_model = SequenceTagger.load('../sample-data/claim-target-tagger/model/final-model.pt')
