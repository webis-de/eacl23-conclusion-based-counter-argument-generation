...
def main(args):
    ...
    dev_dataset   = parse_df(data_dir + 'sample_valid_conclusion_all_preprocessed.pkl',max_input_length=args.max_input_length, max_claim_target=args.max_claim_target, max_argument_target=args.max_argument_target, data_size=1000)
    ...
    for epoch in range(args.num_epoch):
        ...
        for batch in  tqdm.tqdm(train_loader):
            ...
            generated_counter_argument = model.counter_argument_model.generate(input_ids)
            ...
            loss = conclusion_outputs.loss + alpha2 * counter_argument_outputs.loss + alpha3 * counter_argument_stance_loss
